...
### Chores
- **deps:** Raise chia-sdk-* to the 0.36.0 ceiling (#8)

## [0.3.0] - 2026-08-08

### Features
- Bump dig-constants to 0.10 and migrate to the chia-0.36 family (#7)

## [0.2.2] - 2026-08-05

### Bug Fixes
- **ci:** Make create-release reachable on a tag push (#6)

## [0.2.1] - 2026-08-05

### Bug Fixes
- **ci:** Make the tag-push publish guard reachable (#5)
